...
{
    /// <summary>
    /// Логика взаимодействия для AdminDefectView.xaml
    /// </summary>
    public partial class AdminDefectView : Window
    {
        ...
        private void CloseDefect_Click(object sender, RoutedEventArgs e)
        {
            Defect d = dataGrid.SelectedItem as Defect;
            if (d != null)
            {
                DefectClose defectClose = new DefectClose(d);
                defectClose.Show();
                this.Close();
            }
